                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="card">
                                        <div class="card-header"><strong>Add Exams</strong></div>
                                        <div class="card-body card-block">
                                            <div class="form-group">
                                                <label for="category" class="form-control-label">New Exam Category</label>
                                                <input type="text" name="category" id="category" placeholder="Please enter your exam name" class="form-control" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="exam_time_in_minutes" class="form-control-label">Exam Times In Minutes</label>
                                                <input type="text" name="exam_time_in_minutes" id="exam_time_in_minutes" placeholder="Minutes format only" class="form-control" required>
                                            </div>
                                            <div class="form-group" style="display:flex; justify-content:center; align-items:center;">
                                                <input type="submit" name="submit1" class="btn btn-success" value="Add Exam">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
if(isset($_POST["submit1"])){
    ...
    mysqli_query($link,"insert into exam_category values('','$category','$exam_time_in_minutes')");
    ?>
